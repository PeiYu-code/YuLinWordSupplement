...
const wordBank = [
  ...
  { eng: "barn", ch: "穀倉(n.)" },
   { eng: "holder", ch: "支撐物、持有者(n.)" },
   { eng: "ambassador", ch: "大使(n.)" },
   { eng: "suburb", ch: "近郊住宅區(n.)" },
   { eng: "reputation", ch: "名譽(n.)" },
   { eng: "ruin", ch: "破壞(v., n.)" },
   { eng: "ruins", ch: "廢墟(n.)" },
   { eng: "alley", ch: "窄巷道(n.)" },
   { eng: "avenue", ch: "大街、大道(n.)" },
   { eng: "trail", ch: "鄉間小徑(n.)" },
   { eng: "horn", ch: "(車輛)喇叭、號角、犄角(n.)" },
   { eng: "tank", ch: "容器、槽、坦克(n.)" },
   { eng: "trunk", ch: "樹幹、軀幹、後車箱、象鼻(n.)" },
   { eng: "fence", ch: "籬笆、圍欄、劍擊術(n.)" },
   { eng: "tribe", ch: "部落(n.)" },
   { eng: "carriage", ch: "四輪馬車、火車車廂(n.)" },
   { eng: "sorrow", ch: "悲傷(n.)" },
   { eng: "politics", ch: "政治(學)(n.)" },
   { eng: "politician", ch: "政治家、政客(n.)" },
   { eng: "policy", ch: "政策(n.)" },
   { eng: "deed", ch: "行為(n.)" },
   { eng: "democracy", ch: "民主(n.)" },
   { eng: "ownership", ch: "所有權、擁有(n.)" },
   { eng: "poll", ch: "民意調查(n.)" },
   { eng: "republic", ch: "共和國(n.)" },
   { eng: "tag", ch: "標記、貼標籤(v.); 標籤(n.)" },
   { eng: "tap", ch: "輕敲(v.); 水龍頭(n.)" },
   { eng: "spill", ch: "撒出、外洩(v., n.)" },
   { eng: "splash", ch: "濺起水花(v.); 濺出的水漬(n.)" },
   { eng: "spray", ch: "噴霧(v., n.)" },
   { eng: "dealer", ch: "商人(n.)" },
   { eng: "merchant", ch: "商人(尤指外貿批發商)(n.)" },
   { eng: "violate", ch: "違反(v.)" },
   { eng: "appoint", ch: "任命、安排日期(v.)" },
   { eng: "appointment", ch: "約、會面、任命(n.)" },
   { eng: "assign", ch: "指派(v.)" },
   { eng: "assignment", ch: "任務、作業(n.)" },
   { eng: "criticize", ch: "批評、批判(v.)" },
   { eng: "criticism", ch: "批評、評論(n.)" },
   { eng: "critical", ch: "批評的、關鍵的、危及的、批判性的(adj.)" },
   { eng: "critic", ch: "評論家；批評者(n.)" },
   { eng: "organic", ch: "有機的、器官的(adj.)" },
   { eng: "organ", ch: "器官(n.)" },
   { eng: "enforce", ch: "強制執行、把...強加於(v.)" },
   { eng: "enforcement", ch: "強制施行(n.)" },
   { eng: "expand", ch: "擴大、增加、擴張(v.)" },
   { eng: "expansion", ch: "擴大、擴張、增加(n.)" },
   { eng: "involve", ch: "參與、涉及(v.) +in" },
   { eng: "involvement", ch: "參與、投入(n.)" },
   { eng: "resign", ch: "辭職、放棄(v.)" },
   { eng: "resignation", ch: "辭職、聽任、服從(n.)" },
   { eng: "resign oneself to N", ch: "聽任、不得不接受" },
   { eng: "fundamental", ch: "基本的、主要的(adj.)" },
   { eng: "lawn", ch: "草坪(院子或公園內的) (n.)" },
   { eng: "meadow", ch: "草地、牧場(n.)" },
   { eng: "vast", ch: "廣闊的、大量的(adj.)" },
   { eng: "steep", ch: "陡峭的、價格過高的(adj.); 浸泡(v.)" },
   { eng: "grassy", ch: "長滿草的(adj.)" },
   { eng: "digital", ch: "數位的(adj.)" },
   { eng: "hasty", ch: "匆忙的(adj.)" },
   { eng: "largely", ch: "大部分地、大量廣闊地(adv.); 主要地(adv.)" },
   { eng: "yolk", ch: "蛋黃(n.)" },
   { eng: "pad", ch: "防磨擦襯墊(n.)" },
   { eng: "microphone", ch: "麥克風(n.)" },
   { eng: "microscope", ch: "顯微鏡(n.)" },
   { eng: "microwave", ch: "微波爐(n.)" },
   { eng: "marker", ch: "標識、麥克筆(n.)" },
   { eng: "scissors", ch: "剪刀(n.)" },
   { eng: "vase", ch: "花瓶" }
];
